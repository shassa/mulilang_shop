                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> {{$category->name}} قسم </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.main_categories.update',$category->id)}}" method="POST"
                                    ...
                                    @isset($category->categories)
                                       @foreach ($category->categories as $index => $translate)
                                      ...
                                      <div class="tab-content px-1 pt-1">
                                        ...
                                        <div role="tabpanel" class="tab-pane @if($index==0) active @endif" id="tab11{{$index}}" aria-expanded="true" aria-labelledby="base-tab11">
                                            <form class="form" action="{{route('admin.main_categories.update',$translate->id)}}" method="POST"
                                                enctype="multipart/form-data">
                                              @csrf
