                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.sub_categories.store')}}" method="POST"
                                            ...
                                            @if(activelang()->count() > 0)
                                               @foreach(activelang() as $index => $category)
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> اسم القسم {{__('messages.'.$category->abbr)}} </label>
